...
from api.queries import author_with_id, resolve_books_for_author  # resolve_books, resolve_book, resolve_authors, resolve_author
...
schema = make_executable_schema(type_defs, [author, book, query])
